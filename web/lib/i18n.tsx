...
const STRINGS = {
  ...
  "token.chartTab": { en: "Chart", ja: "チャート" },
  "token.curveTab": { en: "Curve", ja: "カーブ" },
  "chart.timeframe": { en: "Timeframe", ja: "時間足" },
  "chart.mcapUsd": { en: "Market cap · USD", ja: "時価総額 · USD" },
  "chart.loading": { en: "Loading chart…", ja: "チャートを読み込み中…" },
  "chart.loadingHistory": { en: "Loading trade history…", ja: "取引履歴を読み込み中…" },
  "chart.noTrades": { en: "No trades yet. The chart starts at the first trade.", ja: "まだ取引はありません。最初の取引からチャートが始まります。" },
  "chart.opensAt": { en: "Opens at {mcap}", ja: "開始時価総額 {mcap}" },
